...
public class TestBTP2 {
	...
	public static void main(String[] args) throws ParseException {
		...
		IAppelOffreRepository appelOffreRepository = context.getBean(IAppelOffreRepository.class);
		IMaitreOeuvreRepository maitreOeuvreRepository = context.getBean(IMaitreOeuvreRepository.class);
		IMaitreOuvrageRepository maitreOuvrageRepository = context.getBean(IMaitreOuvrageRepository.class);
		IOffreRepository offreRepository = context.getBean(IOffreRepository.class);
		IUtilisateurRepository utilisateurRepository= context.getBean(IUtilisateurRepository.class);
		IProjetRepository projetRepository = context.getBean(IProjetRepository.class);
		IActionRepository actionRepository = context.getBean(IActionRepository.class);
		IFactureRepository factureRepository = context.getBean(IFactureRepository.class);
		IPrestataireRepository prestataireRepository = context.getBean(IPrestataireRepository.class);
		ISalarieRepository salarieRepository = context.getBean(ISalarieRepository.class);
		IReunionRepository reunionRepository = context.getBean(IReunionRepository.class);
		IMaterielRepository materielRepository = context.getBean(IMaterielRepository.class);
		IPrestationRepository prestationRepository = context.getBean(IPrestationRepository.class);
		IPrestationSupplementaireRepository prestationSupplementaireRepository = context.getBean(IPrestationSupplementaireRepository.class);
		...
		Prestation presta2 = new Prestation(Categorie.secondOeuvre, "Plomberie", 9000F, sdf.parse("15/09/2020"),
				sdf.parse("25/09/2020"), false, PhasePresta.ValideMOeuvre,"nouvelles fondations pour hypermarché");
