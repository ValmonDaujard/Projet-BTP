...
class Test3 {
	...
	public void test() throws ParseException {
				...
				Facture factureProjetMoisSeptembre = new Facture("Michel", 153453, sdf.parse("16/06/2020"), 5000F, 0F, sdf.parse("15/08/2020"), 0F,
						true,true);
				Facture factureMoisNovembre = new Facture("Michel", 83843, sdf.parse("18/06/2021"), 5000F, 15F, sdf.parse("21/08/2022"), 52F,
						false,true);
