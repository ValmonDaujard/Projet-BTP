...
class Test3 {
	...
	public void test() throws ParseException {
				...
				Facture factureIsolation = new Facture("michel",111, sdf.parse("15/05/2020"), 5000F, 0F, sdf.parse("15/06/2020"), 0F,
						true,false);
				Facture factureCloture = new Facture("truc",45, sdf.parse("18/01/2021"), 5000F, 15F, sdf.parse("21/02/2022"), 52F,
						false,false);
				
				Facture factureProjetMoisSeptembre = new Facture("jesaispas",153453, sdf.parse("16/06/2020"), 5000F, 0F, sdf.parse("15/08/2020"), 0F,
						true,true);
				Facture factureMoisNovembre = new Facture("machin",83843, sdf.parse("18/06/2021"), 5000F, 15F, sdf.parse("21/08/2022"), 52F,
						false,true);
